...
# lstm
tcopts['lstm_train_dir'] = './super_dimp_mu_lof_1'
tcopts['train_data_dir'] = '../results/Super_Dimp_super_dimp_lof/lasot/train_data'
tcopts['pos_thr'] = 0.5
