...
class KeepTrack(BaseTracker):
    ...
    def track(self, image, info: dict = None) -> dict:
        ...
        return output_state,object_presence_score.cpu().item()

    def track_updater(self, image, info: dict = None) -> dict:
        self.debug_info = {}
        ...
        if self.visdom is not None:
            ...
            show_tensor(score_map, 5, title='Max score = {:.2f}'.format(max_score))
        return output_state,object_presence_score.cpu().item(), target_label_certainty,test_x, scale_ind, sample_pos, sample_scales, s,update_flag,learning_rate

    def updater(self,target_label_certainty,test_x, scale_ind, sample_pos, sample_scales, s,learning_rate):
